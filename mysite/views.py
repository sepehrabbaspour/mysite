...
#JsonResponse baraye bargasht dadan khorooji jsoni hast. be hala tjson baresh migardoone
def http_test(request):
    return HttpResponse("<h5>welcome to http-test page</h5>")

def json_test(request):
    return JsonResponse({"name" : "saghar"})

 #hala pasokh ma bayad peygham maro dar bar begire
...
#deghat kon ke request ro hamishe khoda darimesh
